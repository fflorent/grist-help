...
*![Proposal](/examplimages/2023-07-proposals-contracts/final-proposal.png)*
...
*![Projects](/examplimages/2023-07-proposals-contracts/make-projects-table.png)*
...
*![Projects](/examplimages/2023-07-proposals-contracts/column-placeholders.png)*

## Creating templates

Let's add a new table, `Templates`, to the page to store our template data. Add two columns: **Name** and **Template Formatting**. 

*![Templates](/examplimages/2023-07-proposals-contracts/templates-table.png)*
...
*![Add Custom Widget](/examplimages/2023-07-proposals-contracts/add-custom-widget.png)*
...
*![Markdown Widget](/examplimages/2023-07-proposals-contracts/markdown-configuration.png)*
{: .screenshot-half }
...
*![Proposal Template](/examplimages/2023-07-proposals-contracts/create-proposal-template-1.png)*
...
*![markdown-help](/examplimages/2023-07-proposals-contracts/markdown-help.png)*
{: .screenshot-half }

When you click the 'save' icon, formatting from the widget will populate the **Template Formatting** column.

![Proposal Template](/examplimages/2023-07-proposals-contracts/create-proposal-template.png)
...
![Hide Column](/examplimages/2023-07-proposals-contracts/hide-formatting-column.png)
...
![Projects Table](/examplimages/2023-07-proposals-contracts/project-customer-columns.png)
...
![Variables](/examplimages/2023-07-proposals-contracts/project-name-variable.png)
...
![Proposal](/examplimages/2023-07-proposals-contracts/proposal-template.png)
...
![Proposal Formula](/examplimages/2023-07-proposals-contracts/proposal-formula.png)
...
![Add Project Table](/examplimages/2023-07-proposals-contracts/add-projects-table.png)
...
![Add Project Card](/examplimages/2023-07-proposals-contracts/add-projects-card.png)

Your dashboard should look similar to the screenshot below.

![project-dashboard-start](/examplimages/2023-07-proposals-contracts/project-dashboard-start.png)
...
*![Hide Columns](/examplimages/2023-07-proposals-contracts/hide-project-columns.png)*
{: .screenshot-half }
...
![project-table-card](/examplimages/2023-07-proposals-contracts/project-table-card.png)
...
*![Add custom Widget](/examplimages/2023-07-proposals-contracts/add-custom-project-widget.png)*
...
*![Configure Custom Widget](/examplimages/2023-07-proposals-contracts/proposal-custom-widget-configuration.png)*
{: .screenshot-half }
...
*![Populated Proposal](/examplimages/2023-07-proposals-contracts/populated-proposal.png)*
...
*![Customers Table](/examplimages/2023-07-proposals-contracts/customers-table.png)*
...
*![customer-name-reference](/examplimages/2023-07-proposals-contracts/customer-name-reference.png)*
...
*![proposal-reference](/examplimages/2023-07-proposals-contracts/proposal-reference.png)*
...
*![print-proposal](/examplimages/2023-07-proposals-contracts/print-proposal.png)*

From here, you can either select a printer or choose 'Save as PDF' from the 'Destination' dropdown.

*![print-or-pdf](/examplimages/2023-07-proposals-contracts/print-or-pdf.png)*
...
*![contract-template](/examplimages/2023-07-proposals-contracts/contract-template.png)*
...
*![contract-dashboard](/examplimages/2023-07-proposals-contracts/contract-dashboard.png)*
...
*![contract-formula](/examplimages/2023-07-proposals-contracts/contract-formula.png)*
...
*![contract-widget-configuration](/examplimages/2023-07-proposals-contracts/contract-widget-configuration.png)*
