...
<span class="screenshot-large">*![HyperLink Format](/examplimages/2020-07-hyperlink-format.png)*</span>
{: .screenshot-half }

You'll get a link in each person's row, which you can click to start composing an email to that
person:

<span class="screenshot-large">*![Mailto Cells](/examplimages/2020-07-hyperlink-cells.png)*</span>
{: .screenshot-half }
