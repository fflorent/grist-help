    ...
    <table class="header-top"><tr>
      <td class="header-image">
        <a href="https://www.getgrist.com">
          <img class="header-img" srcimages/newsletters/2021-04/april-logo.png" width="80" height="80" alt="Grist Labs" border="0">
        </a>
      </td>
...
![Tutor and family's views](../examplimages/2021-04-link-keys/full-v-limited-access-animated.gif)
...
- **Freezing unique identifiers**. When using the Grist’s
  [`UUID()`](../en/functions.md#uuid) function, you may want to freeze values
